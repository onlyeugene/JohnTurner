...
const Navbar = () => {
  ...
  return (
    <div id="products" className="relative w-full mx-auto bg-[#f4f4f479] flex justify-between items-center md:px-[5rem] px-[2rem] py-[2rem] gap-10  overflow-hidden cursor-pointer border-b border-[#f2f2f279]">
        ...
        <>
          ...
          <div className="fixed top-0 left-0 mx-[14rem] my-[6rem] px-[2rem] py-[1rem] w-[18rem] transform -translate-x-1/2 z-20 bg-white rounded-xl shadow-lg overflow-hidden md:hidden block">
            <div className="font-medium text-end flex flex-col gap-2">
              ...
              <div className="flex items-center justify-end gap-1 hover:text-[#AC702F] pl-[6rem] " onClick={toggleCat}>
